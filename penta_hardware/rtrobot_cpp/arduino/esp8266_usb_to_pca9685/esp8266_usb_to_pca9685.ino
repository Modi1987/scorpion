...
// I2C wiring of ESP8266 and PCA9685:
// 1- Connect pin D1 (GPIO5) of ESP8266 to SCL of PCA9685.
// 2- Connect pin D2 (GPIO4) of ESP8266 to SDA of PCA9685.
...
void disp_authors_message()
{
  ...
  Serial.println("This is a program used to control PentaPod 'Creature'");
  Serial.println("");
