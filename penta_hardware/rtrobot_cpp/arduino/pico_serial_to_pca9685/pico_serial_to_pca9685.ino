...
// Raspberry Pi Pico serial to i2c program,
...
// I2C wiring of Raspberry Pi Pico and PCA9685:
// 1- Connect GP4 (I2C0 SDA) of Pico to SDA of PCA9685.
// 2- Connect GP5 (I2C0 SCL) of Pico to SCL of PCA9685.
// Alternative: GP21 (I2C1 SCL) and GP20 (I2C1 SDA) can also be used

//-- Libraries Included --------------------------------------------------------------
#include <Wire.h>
#include <Adafruit_PWMServoDriver.h>

// Pico I2C pin definitions
#define SDA_PIN 4    // GP4 for I2C0 SDA
#define SCL_PIN 5    // GP5 for I2C0 SCL
//------------------------------------------------------------------------------------
...
void disp_authors_message()
{
  ...
  Serial.println("Raspberry Pi Pico - PentaPod 'Creature' Controller");
  Serial.println("I2C: GP4(SDA), GP5(SCL) -> PCA9685");
  Serial.println("");
