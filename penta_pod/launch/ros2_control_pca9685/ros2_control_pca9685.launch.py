...
def generate_launch_description():
    ...
    use_pca9685_ros2_control_arg = DeclareLaunchArgument(
        "use_pca9685_ros2_control",
        default_value="True",
        description="Use pca9685_ros2_control for controlling the PCA9685 servo controller",
    )
    ...
    robot_description = ParameterValue(
        Command(
            [
                ...
                " use_pca9685_ros2_control:=",
                LaunchConfiguration("use_pca9685_ros2_control"),
            ]
        ),
        value_type=str,
    )
