...
public:
  ...
  virtual void
  init(const int n, const std::vector<double> &a, const std::vector<double> &d,
       const std::vector<double> &alfa, const std::vector<double> &eef_trans,
       const std::vector<double> &q_max, const std::vector<double> &q_min) = 0;

  virtual bool get_ik(const double &x, const double &y, const double &z,
                      const std::vector<double> &q0,
                      std::vector<double> &q_out) = 0;
