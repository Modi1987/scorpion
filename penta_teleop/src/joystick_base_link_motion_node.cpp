...
int main(int argc, char **argv) {
  ...
  auto base_link_motion_node = std::make_shared<rclcpp::Node>("joystick_base_link_motion_control");
  auto base_link_motion_clients_node = std::make_shared<rclcpp::Node>("joystick_base_link_motion_control_clients");
  ...
  /* Turn head using yaw */
  auto turn_head_motion_node = std::make_shared<rclcpp::Node>("turn_head_motion_control");
  auto turn_head_motion_clients_node = std::make_shared<rclcpp::Node>("turn_head_motion_control_clients");
