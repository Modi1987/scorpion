...
namespace penta_pod::kin::base_twerk {
  ...
  class BaseTwerkActionServer {
    private:
      ...
      auto handle_goal(const rclcpp_action::GoalUUID&, std::shared_ptr<const BaseTwerkAction::Goal>)
          -> rclcpp_action::GoalResponse;

      auto handle_cancel(const std::shared_ptr<GoalHandle> goal_handle) -> rclcpp_action::CancelResponse;
      ...
      auto calculate_twerk_pose_from_goal(rclcpp::Time start_time, 
