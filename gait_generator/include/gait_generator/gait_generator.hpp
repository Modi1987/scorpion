...
private:
  ...
  std::vector<geometry_msgs::msg::Point>
      feet_pos_in_footprint_; // current feet pos
  std::vector<geometry_msgs::msg::Point>
  ...
  void cmd_null_pos_sub_callback(
  ...
  invertQuaternion(const geometry_msgs::msg::Quaternion &q) {
  ...
  applyInverseTransform(const geometry_msgs::msg::Point &point,
