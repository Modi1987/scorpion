...
void GaitGenerator::declare_parameters() {
  ...
  node_->declare_parameter<std::string>("gait_parameters.foot_up_motion_type_str", foot_up_motion_type_to_string(FootUpMotionType::CYCLOID));
}
...
void GaitGenerator::load_parameters() {
  ...
  if (!node_->get_parameter("gait_parameters.foot_up_motion_type_str", foot_up_motion_type_str)) {
    ...
    foot_up_motion_type_ = foot_up_motion_type_from_string(foot_up_motion_type_str);
  } else {
    foot_up_motion_type_ = FootUpMotionType::UNKNOWN;
